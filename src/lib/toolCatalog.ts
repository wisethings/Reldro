...
export const GLOBAL_TOOL_CATALOG: CatalogToolSeed[] = [
  ...
  { name: "Excel", category: "PRODUCTIVITY", vendor: "Microsoft", description: "Spreadsheet and data analysis tool, with or without Copilot enabled.", capabilities: ["Spreadsheets", "Data analysis", "Reporting"] },
  { name: "Power BI", category: "ANALYTICS", vendor: "Microsoft", description: "Business intelligence and reporting, with AI-assisted insights (Copilot in Power BI).", capabilities: ["Dashboards", "Reporting", "Data analysis", "AI-assisted insights"] },
